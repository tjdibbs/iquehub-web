  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant='ghost'
          className='inline-flex items-center gap-1 text-base font-medium text-white transition-colors duration-200 hover:bg-gray-100 hover:bg-transparent hover:text-custom-beige max-lg:text-black'
        >
          Programmes
      ...
      <PopoverContent className='z-[9999] w-[400px] rounded-lg border border-gray-200 bg-white p-6 shadow-lg lg:w-[500px]'>
